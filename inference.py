...
save_path = os.path.join(os.path.dirname(current_directory), "drama_train")
os.makedirs(save_path, exist_ok=True)
model_path = os.path.join(save_path, 'coco_prefix-009.pt')
...
pretrained_model = 'drama'  # @param ['COCO', 'Conceptual captions']
